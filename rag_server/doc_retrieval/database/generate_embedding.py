...
def main(args):
    ...
    # faiss_path = os.path.join(args.save_path, 'faiss_pickle.pkl')
    # context_path = os.path.join(args.save_path, 'context_pickle.pkl') if args.save_context else None

    # 이미 있는 DB 불러서 사용 / faiss, context 인자(ㅇㄷ?) 넣어주면 됨 -> faiss_pickle=faiss_path, context_pickle=context_path
